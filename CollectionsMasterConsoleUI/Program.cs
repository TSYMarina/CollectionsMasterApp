...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //LINQ method: var sorted = numbers.OrderBy(x => x);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes, your number is included in the list.");
            }
            else
            {
                Console.WriteLine($"No, this number is not included in the current random numbers list.");
            }
